(() => {
    ...
    const STATIC_TEXT = {
        ...
        'Atilim University Demo - SE 204 Midterm - FaceNet ArcFace Triplet Model 6 - Threshold 0.3000000119': 'Atılım Üniversitesi Demo - SE 204 Ara Sınav - FaceNet ArcFace Triplet Model 6 - Eşik 0.3000000119',
        ...
        'Hybrid FaceNet, FaceNet Proto, FaceNet Contrastive Proto, FaceNet Contrastive Proto Model 5, and FaceNet ArcFace Triplet Model 6 use RGB 160x160 input and a 512-d normalized embedding. The current runtime threshold is an initial setting until target-data calibration supports a production value.': 'Hybrid FaceNet, FaceNet Proto, FaceNet Contrastive Proto, FaceNet Contrastive Proto Model 5 ve FaceNet ArcFace Triplet Model 6, RGB 160x160 girdi ve 512 boyutlu normalize embedding kullanır. Geçerli çalışma zamanı eşiği, hedef veri kalibrasyonu üretim değerini destekleyene kadar başlangıç ayarıdır.',
        'FaceNet Contrastive Proto Model 5': 'FaceNet Contrastive Proto Model 5',
        'FaceNet ArcFace Triplet Model 6': 'FaceNet ArcFace Triplet Model 6',
